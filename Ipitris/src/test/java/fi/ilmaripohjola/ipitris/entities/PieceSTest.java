...
public class PieceSTest {
    ...
    public void moveDownWorks() {
        ...
        assertEquals("2,3", this.p.getBlocks()[3].toString());
    }
    ...
    public void moveUpWorks() {
        ...
        assertEquals("2,0", this.p.getBlocks()[2].toString());
    ...
    public void moveRightWorks() {
        ...
        assertEquals("3,1", this.p.getBlocks()[2].toString());
        assertEquals("3,2", this.p.getBlocks()[3].toString());
    }
